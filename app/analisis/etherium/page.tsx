...
export default function MarketAnalysis() {
    ...
    useEffect(() => {
        const fetchMarketData = async () => {
            const data = await fetchHistoricalData("ETHUSDT");
    ...
    useEffect(() => {
        const interval = setInterval(async () => {
            const price = await fetchCurrentPrice("ETHUSDT");
    ...
    return (
        <div className="p-4">
            <h1 className="text-xl font-bold">Análisis del Mercado de Etherium</h1>
